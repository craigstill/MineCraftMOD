...
float maxBrighten = 1.55;    //Maximum brightening of the screen (should be greater than 1)
float HDRRatio = 0.9;       //Ajust for stronger or subtler HDR (between 0 and 1)
float idealLum = 0.05;       //The prefered average luminosity of the screen (between 0 and 1)
