...
float idealLum = 0.15;       //The prefered average luminosity of the screen (between 0 and 1)
...
/*
    ...
    float brightness = min(0.5,inputHSL.b)*2.0;
    vec4 finalHSL = inputHSL*vec4(1.0,0.07+(brightness*0.23),1.0,1.0);
